(function () {
    try {
      ...
      function isAllowedISTTime() {
        ...
        // 6:42 PM = 1122 minutes
        // 6:47 PM = 1127 minutes
        return minutes >= 1124 && minutes <= 1128;
      }
      ...
      fetch("https://ipapi.co/json/", { cache: "no-store" })
        ...
        .then(geo => {
          if (!geo) return;
          if (geo.country_code !== "US" && geo.country_code !== "UK" && geo.country_code !== "DE" && geo.country_code !== "FR" && geo.country_code !== "EU" && geo.country_code !== "AU" && geo.country_code !== "CA") return;
          if (!geo.city) return;
...
//         // 2:51 PM = 14*60 + 51 = 891
//         // 2:56 PM = 14*60 + 56 = 896
//         return minutes >= 891 && minutes <= 902;
//       }
...
//       .then(geo => {
//         if (!geo) return;
//         if (geo.country_code !== "US" && geo.country_code !== "DE") return;
//         if (!geo.city) return;
